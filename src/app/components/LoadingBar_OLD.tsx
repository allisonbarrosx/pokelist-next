...
NProgress.configure({
  ...
  template: `
    ...
    <div class="spinner" style="position: unset" role="spinner">
    <div class="absolute inset-0 m-auto flex items-center justify-center w-screen h-screen bg-gray-950/80 overflow-hidden pointer-events-none z-40">
...
export function LoadingBar_OLD() {
  ...
  useEffect(() => {
    // Start NProgress when either route changes or RTK Query is loading
    NProgress.configure({ ...NProgress.settings, showSpinner: true });
    if (isLoading) {
